    ...
    <div className="min-h-[85vh] flex-1 px-4 py-10 md:py-16 bg-obsidian-950">
      <div className="mx-auto max-w-3xl rounded border border-white/10 bg-obsidian-900 p-6 shadow-glow-gold md:p-8">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="h-9 w-40 border border-white/10 bg-obsidian-950 animate-pulse" />
        </div>
        ...
        <div className="mt-8 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="h-12 w-full border border-white/10 bg-obsidian-950 animate-pulse" />
          </div>

          {/* Food description textarea */}
          <div className="space-y-2">
            <div className="h-2.5 w-32 rounded bg-white/10 animate-pulse" />
            <div className="h-36 w-full border border-white/10 bg-obsidian-950 animate-pulse" />
          </div>
