      ...
      <div className="mx-auto max-w-6xl relative">
        ...
        <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-3">
            ...
            <div className="h-8 w-64 rounded bg-black/10 dark:bg-white/10 animate-pulse" />
          </div>
          {/* ปุ่ม Add meal + View profile */}
          <div className="flex gap-3">
            <div className="h-9 w-24 border border-gold-accent/20 bg-gold-accent/5 animate-pulse" />
            <div className="h-9 w-28 border border-black/10 dark:border-white/10 bg-white/70 dark:bg-obsidian-900 animate-pulse" />
          </div>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <section className="relative overflow-hidden border border-black/10 dark:border-white/10 bg-white/80 dark:bg-obsidian-900 p-6 shadow-glow-gold md:p-8">
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-center">
              <div className="h-20 w-20 border border-gold-accent/30 bg-black/5 dark:bg-obsidian-950 animate-pulse" />
              <div className="flex-1 space-y-3">
                <div className="h-3 w-20 rounded bg-black/10 dark:bg-white/10 animate-pulse" />
                <div className="h-7 w-48 rounded bg-black/15 dark:bg-white/15 animate-pulse" />
                <div className="h-4 w-72 rounded bg-black/5 dark:bg-white/8 animate-pulse" />
              </div>
            </div>
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-2">
              ...
              <div className="rounded border border-gold-accent/20 bg-black/5 dark:bg-obsidian-950/70 p-4 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="h-2.5 w-16 rounded bg-black/10 dark:bg-white/10 animate-pulse" />
                ...
                <div className="h-3.5 w-36 rounded bg-black/5 dark:bg-white/8 animate-pulse" />
              </div>
              {/* Protein progress skeleton */}
              <div className="rounded border border-emerald-accent/20 bg-black/5 dark:bg-obsidian-950/70 p-4 space-y-3">
                <div className="flex items-center justify-between">
                ...
                <div className="h-3.5 w-40 rounded bg-black/5 dark:bg-white/8 animate-pulse" />
              </div>
            </div>
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              {[1, 2, 3].map((i) => (
                <div key={i} className="rounded border border-black/10 dark:border-white/10 bg-black/5 dark:bg-obsidian-950/60 p-4 space-y-3">
                  <div className="h-2.5 w-12 rounded bg-black/10 dark:bg-white/10 animate-pulse" />
                  <div className="h-4 w-20 rounded bg-black/15 dark:bg-white/15 animate-pulse" />
                </div>
              ))}
            </div>
            ...
            <div className="mt-6 rounded border border-black/10 dark:border-white/10 bg-black/5 dark:bg-obsidian-950/60 p-4">
              <div className="h-2.5 w-28 rounded bg-black/10 dark:bg-white/10 animate-pulse" />
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <div key={i} className="space-y-2">
                    <div className="h-2 w-14 rounded bg-black/10 dark:bg-white/10 animate-pulse" />
                    <div className="h-4 w-24 rounded bg-black/15 dark:bg-white/15 animate-pulse" />
                  </div>
                ))}
              </div>
            </div>
          ...
          <aside className="space-y-6">
            ...
            <div className="relative overflow-hidden border border-black/10 dark:border-white/10 bg-white/80 dark:bg-obsidian-900 p-6">
              ...
              <div className="h-2.5 w-24 rounded bg-black/10 dark:bg-white/10 animate-pulse" />
              <div className="mt-4 space-y-3">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="flex items-center justify-between border-b border-black/10 dark:border-white/10 pb-2 last:border-0">
                    <div className="h-3 w-10 rounded bg-black/10 dark:bg-white/10 animate-pulse" />
                    <div className="h-3 w-12 rounded bg-black/15 dark:bg-white/15 animate-pulse" />
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="relative overflow-hidden border border-black/10 dark:border-white/10 bg-white/80 dark:bg-obsidian-900 p-6">
              ...
              <div className="mt-3 space-y-2">
                <div className="h-3.5 w-full rounded bg-black/5 dark:bg-white/8 animate-pulse" />
                <div className="h-3.5 w-4/5 rounded bg-black/5 dark:bg-white/8 animate-pulse" />
              </div>
