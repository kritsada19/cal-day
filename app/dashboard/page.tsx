        ...
        <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <section className="relative overflow-hidden border border-white/10 bg-obsidian-900 p-6 shadow-glow-gold md:p-8">
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-center">
              <div className="flex h-20 w-20 items-center justify-center border border-gold-accent/50 bg-obsidian-950 text-2xl font-bold text-gold-accent">
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-2">
              <div className="rounded border border-gold-accent/20 bg-obsidian-950/70 p-4">
                <div className="flex items-center justify-between">
                  <p className="text-[9px] tracking-[0.3em] text-white/40 font-mono uppercase">Calories</p>
              ...
              <div className="rounded border border-emerald-accent/20 bg-obsidian-950/70 p-4">
                <div className="flex items-center justify-between">
                  <p className="text-[9px] tracking-[0.3em] text-white/40 font-mono uppercase">Protein</p>
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              <div className="rounded border border-white/10 bg-obsidian-950/60 p-4">
              ...
              <div className="rounded border border-white/10 bg-obsidian-950/60 p-4">
                ...
                <p className="mt-2 text-sm font-semibold text-white">{bmi ?? "—"}</p>
              </div>
              <div className={`rounded border p-4 ${bmiStatus?.tone || "border-white/10 bg-obsidian-950/60"}`}>
                <p className="text-[9px] tracking-[0.3em] text-white/40 font-mono uppercase">Status</p>
            ...
            <div className="mt-6 rounded border border-white/10 bg-obsidian-950/60 p-4">
              <p className="text-[9px] tracking-[0.3em] text-white/40 font-mono uppercase">Personal details</p>
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                <div>
                  <p className="text-[9px] tracking-[0.3em] text-white/40 font-mono uppercase">Gender</p>
                  <p className="mt-1 text-sm font-semibold text-white">{profile?.gender || "—"}</p>
                </div>
                <div>
                  <p className="text-[9px] tracking-[0.3em] text-white/40 font-mono uppercase">Age</p>
                  <p className="mt-1 text-sm font-semibold text-white">{profile?.age ? `${profile.age} years` : "—"}</p>
                </div>
                <div>
                  <p className="text-[9px] tracking-[0.3em] text-white/40 font-mono uppercase">Weight</p>
                  <p className="mt-1 text-sm font-semibold text-white">{profile?.weight ? `${profile.weight} kg` : "—"}</p>
                </div>
                <div>
                  <p className="text-[9px] tracking-[0.3em] text-white/40 font-mono uppercase">Height</p>
                  <p className="mt-1 text-sm font-semibold text-white">{profile?.height ? `${profile.height} cm` : "—"}</p>
                </div>
                <div>
                  <p className="text-[9px] tracking-[0.3em] text-white/40 font-mono uppercase">Exercise level</p>
                  <p className="mt-1 text-sm font-semibold text-white">{profile?.exerciseLevel || "—"}</p>
                </div>
                <div>
                  <p className="text-[9px] tracking-[0.3em] text-white/40 font-mono uppercase">Goal</p>
                  <p className="mt-1 text-sm font-semibold text-white">{profile?.goal || nutritionTargets?.goalLabel || "—"}</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <aside className="space-y-6">
            <div className="relative overflow-hidden border border-white/10 bg-obsidian-900 p-6">
              ...
              <p className="text-[10px] tracking-[0.3em] text-white/40 font-mono uppercase">Quick insights</p>
              <div className="mt-4 space-y-3 text-sm text-white/70">
                <div className="flex items-center justify-between border-b border-white/10 pb-2">
                  <span className="text-white/45">BMR</span>
                  <span className="font-semibold text-white">{nutritionTargets?.bmr ?? "—"}</span>
                </div>
                <div className="flex items-center justify-between border-b border-white/10 pb-2">
                  <span className="text-white/45">TDEE</span>
                  <span className="font-semibold text-white">{nutritionTargets?.tdee ?? "—"}</span>
                </div>
                <div className="flex items-center justify-between">
            ...
            <div className="relative overflow-hidden border border-white/10 bg-obsidian-900 p-6">
              ...
              <p className="text-[10px] tracking-[0.3em] text-white/40 font-mono uppercase">Next step</p>
              <p className="mt-3 text-sm leading-7 text-white/70">
                Add your personal details to unlock a complete daily nutrition plan and keep your dashboard meaningful.
              </p>
              <Link
                href="/profile/form"
                className="mt-5 inline-flex items-center justify-center border border-gold-accent/40 bg-obsidian-950 px-4 py-2 text-[10px] font-semibold tracking-[0.25em] text-gold-accent transition-all duration-300 hover:bg-gold-accent/10 hover:text-white"
              >
                Fill profile
              </Link>
            </div>
