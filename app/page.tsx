    ...
    <div className="min-h-[85vh] flex-1 px-4 py-10 md:py-16 relative overflow-hidden bg-[#f8f6f1] dark:bg-obsidian-950">
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-8">
          <section className="relative overflow-hidden rounded-2xl border border-black/10 dark:border-white/10 bg-white/80 dark:bg-obsidian-900/90 p-8 shadow-[0_0_80px_rgba(212,175,55,0.08)] md:p-10">
            ...
            <h1 className="mt-6 text-4xl font-bold leading-tight tracking-[0.25em] text-obsidian-950 dark:text-white sm:text-5xl">
              CALDAY
            ...
            <p className="mt-6 max-w-2xl text-sm leading-7 text-obsidian-950/70 dark:text-white/70 sm:text-base">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              {[
                ...
                <span key={tag} className="border border-black/10 dark:border-white/10 bg-black/5 dark:bg-obsidian-950 px-3 py-1.5 text-[10px] font-mono uppercase tracking-[0.3em] text-obsidian-950/50 dark:text-white/50">
                  {tag}
                </span>
              ))}
            </div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link
                href="/signup"
                className="inline-flex items-center justify-center border border-gold-accent/40 bg-black/5 dark:bg-obsidian-950 px-6 py-3 text-[11px] font-semibold uppercase tracking-[0.25em] text-gold-accent transition-all duration-300 hover:bg-gold-accent/10 hover:text-obsidian-950 dark:hover:text-white"
              >
                Start tracking
              </Link>
              <Link
                href="/signin"
                className="inline-flex items-center justify-center border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 px-6 py-3 text-[11px] font-semibold uppercase tracking-[0.25em] text-obsidian-950/80 dark:text-white/80 transition-all duration-300 hover:border-black/20 dark:hover:border-white/20 hover:text-obsidian-950 dark:hover:text-white"
              >
                Open profile
              </Link>
            </div>
          ...
          <div className="space-y-6">
            <div className="relative overflow-hidden rounded-2xl border border-black/10 dark:border-white/10 bg-white/80 dark:bg-obsidian-900/90 p-6 md:p-8">
              <div className="absolute top-0 left-0 h-px w-full bg-linear-to-r from-transparent via-emerald-accent to-transparent" />
              <p className="text-[10px] font-mono uppercase tracking-[0.35em] text-obsidian-950/40 dark:text-white/40">
                What this app does
              </p>
              <h2 className="mt-2 text-2xl font-semibold tracking-[0.25em] text-obsidian-950 dark:text-white">
                Stay focused
              </h2>

              <div className="mt-5 space-y-3 text-sm leading-7 text-obsidian-950/70 dark:text-white/70">
                <p>
            ...
            <div className="relative overflow-hidden rounded-2xl border border-black/10 dark:border-white/10 bg-white/80 dark:bg-obsidian-900 p-6 md:p-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm font-semibold uppercase tracking-[0.2em] text-obsidian-950 dark:text-white">
                    Clean and modern
                  </p>
                </div>
              </div>
              <p className="mt-4 text-sm leading-7 text-obsidian-950/70 dark:text-white/70">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {highlights.map((item) => (
            <article key={item.title} className="relative overflow-hidden rounded-2xl border border-black/10 dark:border-white/10 bg-white/80 dark:bg-obsidian-900/90 p-6">
              ...
              <h3 className="mt-3 text-lg font-semibold uppercase tracking-[0.2em] text-obsidian-950 dark:text-white">{item.title}</h3>
              <p className="mt-3 text-sm leading-7 text-obsidian-950/65 dark:text-white/65">{item.description}</p>
            </article>
          ))}
        </div>
      </div>
